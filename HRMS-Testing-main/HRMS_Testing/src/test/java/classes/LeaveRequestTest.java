...
public class LeaveRequestTest {
    ...
    public void testSetEmployee() {
        Employee newEmployee = new Employee("Ali", 70, "Ali123", "newpassword", new Address("Heliopolis", "Cairo", "11111", "Egypt"), 
                                            "Mechanical Engineering", EmployeeType.FullTime, Evaluation.Excellent);
